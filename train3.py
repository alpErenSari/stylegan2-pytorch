...
from dataset import MultiResolutionDataset, MultiResolutionDatasetRandomCrop
...
def train(args, loader, generator, discriminator, g_optim, d_optim, g_ema, device):
    ...
    for idx in pbar:
        ...
        noise = [torch.cat([cur_noise, gen_label_emb], dim=1) for cur_noise in noise]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--size_dataset", type=int, default=256, help="image sizes of the dataset"
    )
    parser.add_argument(
    ...
    # dataset = MultiResolutionDataset(args.path, transform, args.size_dataset)
    dataset = MultiResolutionDatasetRandomCrop(args.path, transform, args.size_dataset, crop_res=(args.size, args.size))
